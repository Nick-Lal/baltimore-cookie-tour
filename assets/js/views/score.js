...
import { state, subscribe, emit, stopById } from '../lib/state.js?v=32b96abd';
import { totalScore, recipeScore, requestPersistence } from '../lib/storage.js?v=32b96abd';
import { CLUSTER_COLOURS } from './stops.js?v=32b96abd';
