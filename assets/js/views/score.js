...
import { state, subscribe, emit, stopById } from '../lib/state.js?v=6fe1afa3';
import { totalScore, recipeScore, requestPersistence } from '../lib/storage.js?v=6fe1afa3';
import { CLUSTER_COLOURS } from './stops.js?v=6fe1afa3';
