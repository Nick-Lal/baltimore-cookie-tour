...
import { state, subscribe, emit, stopById } from '../lib/state.js?v=0de767c1';
import { totalScore, recipeScore, requestPersistence } from '../lib/storage.js?v=0de767c1';
import { CLUSTER_COLOURS } from './stops.js?v=0de767c1';
