...
import { state, subscribe, emit, stopById } from '../lib/state.js?v=8840a507';
import { totalScore, recipeScore, requestPersistence } from '../lib/storage.js?v=8840a507';
import { CLUSTER_COLOURS } from './stops.js?v=8840a507';
