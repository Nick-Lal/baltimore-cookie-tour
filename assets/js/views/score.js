...
import { state, subscribe, emit, stopById } from '../lib/state.js?v=57c75c85';
import { totalScore, recipeScore, requestPersistence } from '../lib/storage.js?v=57c75c85';
import { CLUSTER_COLOURS } from './stops.js?v=57c75c85';
