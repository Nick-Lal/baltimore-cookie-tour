...
import { state, subscribe, emit, stopById } from '../lib/state.js?v=1ffb8f31';
import { totalScore, recipeScore, requestPersistence } from '../lib/storage.js?v=1ffb8f31';
import { CLUSTER_COLOURS } from './stops.js?v=1ffb8f31';
